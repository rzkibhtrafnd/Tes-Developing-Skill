        ...
        <div class="p-6 bg-white shadow-md sm:rounded-lg">
            <div class="flex justify-between mb-6">
                ...
                <a href="{{ route('toko.create') }}"
                    ...
                    <i class="mr-2 fas fa-plus"></i> Tambah Toko
                </a>
            </div>
            ...
            <div class="overflow-x-auto">
                ...
                <thead class="bg-gray-100">
                    <tr>
                        ...
                        <th class="px-4 py-2 font-semibold text-left text-gray-600">Kode Toko Baru</th>
                        <th class="px-4 py-2 font-semibold text-left text-gray-600">Kode Toko Lama</th>
                    ...
                    @forelse ($data as $toko)
                        <tr class="transition hover:bg-gray-50">
                            ...
                            <td class="px-4 py-2 text-gray-500">
                                {{ $toko->kode_toko_lama ?? '[Kosong / NULL]' }}
                            </td>
                            <td class="px-4 py-2 space-x-2 text-right">
                                <a href="{{ route('toko.edit', $toko->kode_toko_baru) }}"
                                ...
                                <form action="{{ route('toko.destroy', $toko->kode_toko_baru) }}" method="POST" class="inline">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit"
                                            ...
                                            onclick="return confirm('Yakin ingin menghapus data toko ini?')">
                    ...
                    @empty
                        <tr>
                            <td colspan="4" class="px-4 py-3 text-center text-gray-500">
                                <i class="mr-2 fas fa-inbox"></i> Belum ada data toko.
                            </td>
                        </tr>
                    @endforelse
                </tbody>
