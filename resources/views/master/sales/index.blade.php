        ...
        <div class="p-6 bg-white shadow-md sm:rounded-lg">
            <div class="flex justify-between mb-6">
                ...
                <a href="{{ route('sales.create') }}"
                    ...
                    <i class="mr-2 fas fa-plus"></i> Tambah Sales
                </a>
            </div>
                ...
                <table class="min-w-full text-sm border divide-y divide-gray-200 rounded-lg">
                    <thead class="bg-gray-100">
                        <tr>
                            ...
                            <th class="px-4 py-2 font-semibold text-left text-gray-600">Kode Sales</th>
                            <th class="px-4 py-2 font-semibold text-left text-gray-600">Nama Sales</th>
                    ...
                    <tbody class="divide-y divide-gray-200">
                        @forelse ($data as $sales)
                            <tr class="transition hover:bg-gray-50">
                                ...
                                <td class="px-4 py-2 font-medium text-gray-900">{{ $sales->kode_sales }}</td>
                                <td class="px-4 py-2 text-gray-500">{{ $sales->nama_sales }}</td>
                                <td class="px-4 py-2 space-x-2 text-right">
                                    ...
                                    <form action="{{ route('sales.destroy', $sales->id) }}" method="POST" class="inline">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit"
                        ...
                        @empty
                            <tr>
                                <td colspan="4" class="px-4 py-3 text-center text-gray-500">
                                    <i class="mr-2 fas fa-inbox"></i> Belum ada data sales.
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
